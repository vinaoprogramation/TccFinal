...
export default function AdicionaImpressao({ navigation }) {
 ...
 const mostraPop = async (nome, categoria, tempo, maquina, material, cor, gramas) => {
   const mostra = await cadastra(nome, categoria, tempo, maquina, material, cor, gramas);
   if (mostra) {
     Toast.show({
       type: "success",
 ...
 const cadastra = async (nome, categoria, tempo, maquina, material, cor, gramas) => {
   if (!nome || !categoria || !tempo || !maquina || !material || !cor || !gramas) {
   ...
   const envia = await cadastraImpressao(nome, categoria, tempo, maquina, material, cor, gramas);
   if (!envia) {
               ...
               <View style={styles.decisoes}>
                 ...
                 <TouchableOpacity style={styles.botaoDecisaoSalvar}
                   onPress={() => {
                     ...
                     mostraPop(nome, categoriasValor, tempo, maquinasValor, materiaisValor, estoqueValor, gramas)
                   }}
