...
import FiltrosEstoque from "../../Reutilizaveis/FiltrosEstoque";
import BotaoFiltrosEstoque from "../../Reutilizaveis/BotaoFiltrosEstoque";



export default function Estoque({ navigation }) {
    const recarregando = useEstoque((state) => state.recarregando);
                            ...
                            estoque.length == 0 ?
                                <>
                                    <View style={{ marginTop: 50, marginBottom: 100 }}>
                                        <Text style={{ fontSize: 18, marginLeft: 20, fontWeight: 'bold' }}>Não há materiais.</Text>
                                    </View>
                                </>
                                :
                                null
